      ...
      <main className="main-container">
        ...
        <div className="main-cards">
          <div className="card">
            ...
            <h1 className="value">{exmple.temperature.toFixed(2)}°C</h1>
          ...
          <div className="card">
            ...
            <div className="card-content">
              {exmple.tensionArterielle && (
                <>
                  <h4 className="value">
                    Systolic {exmple.tensionArterielle.systolique.toFixed(2)}
                    mmHg
                  </h4>
                  <span style={{ margin: "0 10px" }}></span>
                  <h4 className="value">
                    Diastolic {exmple.tensionArterielle.diastolique.toFixed(2)}
                    mmHg
                  </h4>
                </>
              )}
          ...
          <div className="card">
            ...
            <h1 className="value">{exmple.saturationOxygene.toFixed(2)}%</h1>
          </div>
          <div className="card">
            <div className="card-inner">
              <h3>Glycemie</h3>
            ...
            <h1 className="value">{exmple.glycemie.toFixed(2)}mg/L</h1>
          </div>
          <div className="card">
            <div className="card-inner">
            ...
            <h1 className="value">
              {exmple.frequenceRespiratoire.toFixed(2)}cpm
            </h1>
            <img
