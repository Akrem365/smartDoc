import {
  ...
  NOTIFICATIONS_SUCCES,
  NOTIFICATIONS_BEGIN,
  DELETE_NOTIFICATIONS_BEGIN,
  DELETE_NOTIFICATIONS_SUCCES,
} from "./action";
...
const reducer = (state, action) => {
  ...
  if (action.type === SET_EDIT_PATIENT) {
    ...
    const { _id, name, lastName, age, genre, antecedent, phoneNumber, bed } =
      patient;
    return {
      ...state,
      isEditing: true,
  ...
  if (action.type === SEND_TO_APPOINTMENT) {
    ...
    const { _id, name, lastName, age, phoneNumber, bed } = patient;
    return {
      ...state,
  ...
  if (action.type === NOTIFICATIONS_BEGIN) {
    return {
      ...state,
      isLoading: true,
    };
  }
  if (action.type === NOTIFICATIONS_SUCCES) {
    return {
      ...state,
      ...
      // showAlert: true,
      // alertType: "success",
      // alertText: "Notifications Available!",
    };
  }
  if (action.type === DELETE_NOTIFICATIONS_BEGIN) {
    return {
      ...state,
      isLoading: true,
    };
  }
  if (action.type === DELETE_NOTIFICATIONS_SUCCES) {
    return {
      ...state,
      notifications: [],
      isLoading: false,
